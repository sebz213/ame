...
function catalogIntro({ symbols, title, r, hasPlayground, documented, mountable, animated }) {
  ...
  if (hasPlayground) {
    intro +=
      ...
      (mountable
        ? ', then a controls panel for its full prop surface, a set of variation examples, '
        : ', ') +
      'the props, and the source.'
  } else if (documented && mountable) {
    intro +=
      'This page shows a controls panel for its full prop surface, a set of variation ' +
